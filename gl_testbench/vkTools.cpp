...
void vkTools::CreateRenderPass( const VkDevice& device, const VkFormat& format, const VkImageLayout& initial_layout, const VkImageLayout& final_layout, VkRenderPass& render_pass )
{
    ...
    colorAttachment.initialLayout = initial_layout;// VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL; //VK_IMAGE_LAYOUT_UNDEFINED
