...
GPUMemoryBlock::GPUMemoryBlock(const VkDevice& device, const VkPhysicalDevice& physical_device, std::size_t total_size)
{
    m_p_device = &device;
...

    {
        ...
        memory_allocate_info.memoryTypeIndex = vkTools::FindMemoryType(*m_p_physical_device, memory_requirements.memoryTypeBits, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT);
